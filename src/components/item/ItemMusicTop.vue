<template>
  <div class="itemMusicTop">
    ...
    <div class="itemRight">
      <svg class="icon" aria-hidden="true" id="sousuo">
        <use xlink:href="#icon-sousuo-white-copy"></use>
      </svg>
  ...
  <div class="itemTopContent">
    <div class="contentLeft">
      ...
      <div class="playCount">
        <svg class="icon" aria-hidden="true">
          <use xlink:href="#icon-gl-play-white-copy"></use>
        </svg>
  ...
  <div class="itemTopFooter">
    ...
    <div class="footerItem">
      <svg class="icon" aria-hidden="true">
        <use xlink:href="#icon-xiazai-wenjianxiazai-white-copy"></use>
      </svg>
      <span>下载</span>
    </div>
    <div class="footerItem">
